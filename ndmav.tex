...
\item    If $S$ is complete and decomposable, then it is \emph{valid} \customcite{Darwiche2009}\customcite{Poon2011}
\end{enumerate}  
...
\begin{center}
\onslide<1-8>{
    \only<1>{\includegraphics[width=0.33\columnwidth]{figures/spn-eval.pdf}}
    \only<2>{\includegraphics[width=0.33\columnwidth]{figures/spn-eval-ev-1.pdf}}
    \only<3>{\includegraphics[width=0.33\columnwidth]{figures/spn-eval-ev-2.pdf}}
    \only<4>{\includegraphics[width=0.33\columnwidth]{figures/spn-eval-ev-3-s.pdf}}
    \only<5>{\includegraphics[width=0.33\columnwidth]{figures/spn-eval-ev-4-s.pdf}}
    \only<6>{\includegraphics[width=0.33\columnwidth]{figures/spn-eval-ev-5-s.pdf}}
    \only<7>{\includegraphics[width=0.33\columnwidth]{figures/spn-eval-ev-6-s.pdf}}
    \only<8>{\includegraphics[width=0.33\columnwidth]{figures/spn-eval-ev-7-s.pdf}}
}
\end{center}
\end{frame}
...
\begin{frame}
  \frametitle{SPNs as NNs (II)\customcite{Vergari2016a}}
  \small
...
\begin{frame}
  \frametitle{SPNs as NNs (IV): filters\customcite{Vergari2016a}}
  \small
...
\begin{frame}
  ...
  \item \textbf{encoding} a sample into an inner nodes embedding
     \item \textbf{decoding} an embedding back into input space by MPE top
      down traversal
  \end{itemize}
  \footfullcitenomarkleft{Vergari et al. Encoding and Decoding
